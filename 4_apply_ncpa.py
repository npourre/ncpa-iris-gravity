...
# LAUNCH ON ISS
# =============================================================================
def apply_offset(ncpa_offset, indTel, noll, user):
...
if __name__ == '__main__':
    ...
    if args.tel==0: #all UTs measurements
        for indTel in range(4):
            apply_offset(ncpa_offset,indTel,args.noll, args.user_input)
    elif args.tel in [1,2,3,4]: #one UT measurement
        apply_offset(ncpa_offset,args.tel-1,args.noll, args.user_input)
    else:
